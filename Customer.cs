...
namespace LemondStandTest
{
    public class Customer
    {
        ...
        public string FavRecipe { get; set; }
        public string FavForecast { get; set; }
        ...
        public Customer(string favRecipe, string favForecast) 
        {
            ...
            List<object> LemonadeBuyers = new List<object>() { CustomerOne., CustomerTwo, CustomerThree, CustomerFour, CustomerFive, CustomerSix, CustomerSeven, CustomerEight, CustomerNine, CustomerTen };

        }

        //todo: create random generators

        public void CallingCustomers(Customer LemonadeBuyers)
        {
